...
@RequestMapping(value = LKFrameworkStatics.WEB_MAPPING_API + "/SysCompScheduleConfig/L")
...
public class C extends LKApiBusGetListController<I, O, SysCompScheduleConfigEntity> {
	...
	@Override
	protected LKApiBusGetListService<I, O, SysCompScheduleConfigEntity> getService(I cin, ApiKeyValues<I> params) {
		return service;
	}
