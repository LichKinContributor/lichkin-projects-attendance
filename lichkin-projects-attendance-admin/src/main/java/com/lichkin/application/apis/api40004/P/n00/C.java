...
@RequestMapping(value = LKFrameworkStatics.WEB_MAPPING_API + "/SysEmployeePunchTheClock/P")
...
public class C extends LKApiBusGetPageController<I, O, SysEmployeePunchTheClockEntity> {
	...
	@Override
	protected LKApiBusGetPageService<I, O, SysEmployeePunchTheClockEntity> getService(I cin, ApiKeyValues<I> params) {
		return service;
	}
