...
@RequestMapping(value = LKFrameworkStatics.WEB_MAPPING_API_WEB_ADMIN + "/SysEmployeeAttendance/P")
...
public class C extends LKApiBusGetPageController<I, O, SysEmployeeAttendanceEntity> {
	...
	@Override
	protected LKApiBusGetPageService<I, O, SysEmployeeAttendanceEntity> getService(I cin) {
		return service;
	}
