...
public class C extends LKApiYYController<I, CO, SO> {
	...
	@Override
	protected CO afterInvokeService(I cin, ApiKeyValues<I> params, SO sout) throws LKException {
		...
		if (StringUtils.isNotBlank(scheduleInfo)) {
			String dayOff = LKI18NUtils.getString(LKI18NUtils.getLocale(params.getLocale()), "app-attendance-api-extends", "com.lichkin.api.dayOff");
