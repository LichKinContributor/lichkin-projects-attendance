...
@RequestMapping(value = LKFrameworkStatics.WEB_MAPPING_API_WEB_ADMIN + "/SysCompScheduleConfig/O")
...
public class C extends LKApiBusGetOneController<I, O, SysCompScheduleConfigEntity> {
	...
	@Override
	protected LKApiBusGetOneService<I, O, SysCompScheduleConfigEntity> getService(I cin) {
		return service;
	}
