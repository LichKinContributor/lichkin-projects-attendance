...
public class C extends LKApiBusDeleteController<LKRequestIDsBean, SysEmployeeScheduleConfigEntity> {
	...
	@Override
	protected LKApiBusDeleteService<LKRequestIDsBean, SysEmployeeScheduleConfigEntity> getService(LKRequestIDsBean cin, ApiKeyValues<LKRequestIDsBean> params) {
		return service;
	}
